          ...
          {farmer ? (
            signupMode ? (
                <div className="h-full py-4 flex flex-col *:text-white gap-2">
                  <input type="text"  className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="User Name" />
                  <input type="text"  className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="Full Name" />
                  <input type="email" className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="Email Id" />
                  <input type="text"  maxLength={10}  className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="Mobile Number" />
                  <input type="password" className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="Enter Password" />
                  <input type="password"   className="w-full border border-green-500 outline-0 p-2 rounded" placeholder="Confirm Password" />
