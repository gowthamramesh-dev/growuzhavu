const NavbarTop = () => {
  return (
    <>
      <div className="flex justify-center items-center p-2 h-full bg-slate-950 border-b border-green-500">
        <div className="w-full h-full flex justify-between items-center">
          ...
          <div className="flex flex-row gap-3 items-center">
            ...
            <div className="border flex justify-center items-center text-3xl border-green-500 w-10 h-10 rounded-full">
              <i className="bi bi-person-fill text-green-500 text-2xl"></i>
            </div>
