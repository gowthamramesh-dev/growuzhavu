      ...
      <div className="bg-slate-100 dark:bg-slate-950 w-full h-dvh lg:group">
        <div className="p-2 flex flex-col h-full justify-center gap-10">
          <div className="flex flex-col gap-2 lg:gap-1">
            ...
            <ul className="*:border *:border-green-500 *:overflow-hidden *:hover:bg-slate-200 *:hover:dark:bg-slate-800 *:dark:border-green-500 *:flex *:px-1 lg:*:justify-center **:*:text-black **:*:dark:text-white lg:group-hover:*:justify-normal lg:group-hover:*:px-2 flex flex-col gap-5 lg:group-hover:gap-3 **:gap-1 lg:**:gap-3 *:**:flex *:**:items-center  *:**:py-1 **:h-full *:hover:border-green-500 ">
