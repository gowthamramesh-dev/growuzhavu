const Navbar = () => {
  return (
    <>
      <div className="px-5 h-full bg-slate-950">
        <div className="h-full">
          <div className="border-b border-gray-600 h-1/12 flex items-center">
            <h1 className="text-3xl w-full flex justify-center">Grow Uzhavu</h1>
          </div>
          <div className=" flex justify-center items-center h-1/12 border-b border-gray-600 ">
            <button
              type="button"
          ...
          <div className="h-9/12 border-b border-gray-600 p-2 flex flex-col gap-10">
            <div className="flex flex-col gap-3 justify-center">
              <h1 className="text-md text-gray-600">Marketplace</h1>
              <ul className="text-lg flex flex-col px-1.5 gap-3 *:flex *:justify-start *:gap-1.5 *:items-center *:hover:cursor-pointer **:*:text-gray-600 *:hover:text-green-500">
                <li>
            ...
            <div className="flex flex-col gap-3 justify-center overflow-hidden">
              <h1 className="text-gray-600 text-md h-1/12 ">Account</h1>
              <ul className="no-scrollbar text-lg flex flex-col px-1.5 gap-3 *:flex *:justify-start *:gap-1.5 *:hover:cursor-pointer *:items-center **:*:text-gray-600 *:hover:text-green-500 h-full overflow-y-scroll ">
                <li>
