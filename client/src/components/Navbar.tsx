      ...
      <div className="px-5 h-full bg-slate-950 border-r border-r-green-500">
        <div className="h-full">
          ...
          <div className=" flex justify-center items-center h-1/12 border-b border-green-500 ">
            <button
              type="button"
              className="bg-yellow-500 rounded-xs px-2 lg:text-xl flex items-center nth-[1]:items-baseline justify-center gap-1"
            >
              Create
              <i className="bi bi-box-arrow-in-up-right text-xs "></i>
            </button>
          </div>
          <div className="h-9/12 border-b border-green-500 py-2 flex flex-col gap-10">
            <div className="flex flex-col gap-3 justify-center">
              <h1 className="text-xs lg:text-md text-green-500">Marketplace</h1>
              <ul className="text-sm lg:text-lg flex flex-col px-1.5 gap-3 *:flex *:justify-start *:gap-1.5 *:items-center *:hover:cursor-pointer **:*:text-green-500 *:hover:text-green-500">
                <li>
            ...
            <div className="flex flex-col gap-3 justify-center overflow-hidden">
              <h1 className="text-green-500 text-xs lg:text-md h-1/12 ">
                Account
              </h1>
              <ul className="no-scrollbar text-sm lg:text-lg flex flex-col px-1.5 gap-3 *:flex *:justify-start *:gap-1.5 *:hover:cursor-pointer *:items-center **:*:text-green-500 *:hover:text-green-500 h-full overflow-y-scroll ">
                <li>
          ...
          <div className="text-sm flex flex-col items-center justify-center h-1/12 ">
            ...
            <a
              className="hover:text-green-500 text-xs lg:text-sm"
